...
func GetNBATeams() []Team {
	return []Team{
		{1610612737, "ATL", "Hawks", 1949, "Atlanta", "Atlanta Hawks", "Georgia", []int{1958}},
		...
		{1610612743, "DEN", "Nuggets", 1976, "Denver", "Denver Nuggets", "Colorado", []int{2023}},
		{1610612744, "GSW", "Warriors", 1946, "Golden State", "Golden State Warriors", "California", []int{1947, 1956, 1975, 2015, 2017, 2018, 2022}},
...
func GetWNBATeams() []Team {
	return []Team{
		{1611661313, "NYL", "Liberty", 1997, "New York", "New York Liberty", "New York", []int{}},
		{1611661317, "PHO", "Mercury", 1997, "Phoenix", "Phoenix Mercury", "Arizona", []int{2007, 2009, 2014}},
		{1611661319, "LVA", "Aces", 1997, "Las Vegas", "Las Vegas Aces", "Nevada", []int{2022, 2023}},
		{1611661320, "LAS", "Sparks", 1997, "Los Angeles", "Los Angeles Sparks", "California", []int{2001, 2002, 2016}},
		{1611661321, "DAL", "Wings", 1998, "Dallas", "Dallas Wings", "Texas", []int{2003, 2006, 2008}},
		{1611661322, "WAS", "Mystics", 1998, "Washington", "Washington Mystics", "District of Columbia", []int{2019}},
		{1611661323, "CON", "Sun", 1999, "Connecticut", "Connecticut Sun", "Connecticut", []int{}},
		{1611661324, "MIN", "Lynx", 1999, "Minnesota", "Minnesota Lynx", "Minnesota", []int{2011, 2013, 2015, 2017}},
		{1611661325, "IND", "Fever", 2000, "Indiana", "Indiana Fever", "Indiana", []int{2012}},
		{1611661328, "SEA", "Storm", 2000, "Seattle", "Seattle Storm", "Washington", []int{2004, 2010, 2018, 2020}},
		{1611661329, "CHI", "Sky", 2005, "Chicago", "Chicago Sky", "Illinois", []int{2021}},
		{1611661330, "ATL", "Dream", 2008, "Atlanta", "Atlanta Dream", "Georgia", []int{}},
	}
}
